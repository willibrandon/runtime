...
extern bool EventPipe_PrepareForFork();
extern bool EventPipe_ResumeParentAfterFork();
...
extern "C" __attribute__((visibility("default"))) int ankus_probe_eventpipe_checkpoint(bool pause)
{
    return (pause ? EventPipe_PrepareForFork() : EventPipe_ResumeParentAfterFork()) ? 1 : 0;
}
